...
3. Update docs and run release or packaging checks only when release, packaging, deploy, scheduler, or install paths are touched, then leave the tree public-repo-safe and ready for review, tag, or release handoff.
